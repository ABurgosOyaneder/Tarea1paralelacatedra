...
{
    //crear archivos    
    FILE *x=fopen("rango 1.txt","w");
    FILE *y=fopen("rango 2.txt","w");
    FILE *z=fopen("rango 3.txt","w");
    FILE *n=fopen("rango 4.txt","w");
    FILE *m=fopen("rango 5.txt","w");
    FILE *h=fopen("rango 6.txt","w");
    FILE *h=fopen("rango 7.txt","w");
